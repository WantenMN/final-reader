...
import { MenuIcon, XIcon, SettingsIcon, PlusIcon, MinusIcon, HomeIcon, ChevronUpIcon, ChevronDownIcon } from "lucide-react";
    ...
    <>
      ...
      <div className={headerClasses}>
        ...
        <div className="flex items-center gap-2">
          <Link href="/" className="flex items-center justify-center p-1.5 rounded-md hover:bg-gray-200 transition-colors duration-300" aria-label="Home">
        ...
        <div className="flex items-center">
          <button onClick={toggleHeader} className="p-1.5 rounded-md hover:bg-gray-200 transition-colors duration-300 cursor-pointer" aria-label="Hide Header">
      ...
      {!isHeaderVisible && (
        <div className="fixed top-2 right-4 z-50">
          ...
          <button onClick={toggleHeader} className="p-1.5 rounded-md hover:bg-gray-200 transition-colors duration-300 cursor-pointer" aria-label="Show Header">
