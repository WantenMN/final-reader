      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:border-gray-300 hover:shadow-lg">
        ...
        <div className="p-4">
          <div className="h-12 flex flex-col justify-between">
            <h2 className="text-base font-semibold text-gray-900 line-clamp-2" title={book.title}>
              {book.title}
            </h2>
          </div>
          <div className="mt-2 h-5">
            <p className="text-sm text-gray-600 truncate" title={book.author ?? 'Unknown Author'}>
